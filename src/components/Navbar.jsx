            ...
            <div className="flex md:gap-x-20 justify-between lg:px-12 min-[320px]:px-4">
                ...
                <div className="flex lg:flex-row flex-row-reverse justify-between items-center w-full ">
                    ...
                    <div
                        className={
                            isActive
                                ? 'Navigasi text-[#ffffff8C] font-normal lg:static min-[320px]:flex-col min-[320px]:w-[100%] lg:w-[40%] min-[320px]:left-0 min-[320px]:px-4 lg:flex  min-[320px]:absolute min-[320px]:top-[100%] gap-x-8 md:pl-[60%] lg:pl-0'
                    ...
                    >
                        <div className="min-[320px]:bg-slate-900/90 min-[320px]:flex min-[320px]:flex-col lg:flex-row lg:bg-transparent min-[320px]:py-6 min-[320px]:px-8 min-[320px]:gap-y-4 min-[320px]:rounded-b-xl gap-x-12">
